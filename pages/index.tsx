...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  let profit = "লাভ"
  const sell = Math.floor((Number(env_data.stock) *Number(price)) - Number(env_data.vat))
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          বর্তমানে আমাদের শেয়ার <b> {data.profit_money} টাকা {data.profit} </b>  এ আছে
        </p>
        <h1 className={styles.card2}>
          <a href="/">আবার চেক করো</a>
        </h1>
        ...
        <div className={styles.grid}>
          <div className={styles.card}>
            ...
            <p> ১। স্টক কেনা হয়েছেঃ <b>{data.stock}</b>  টি <br></br>
                ২। কেনার সময় প্রতি শেয়ারের মুল্য ছিলঃ <b> {data.buy_per_share}</b> টাকা <br></br>
                ৩। বিক্রি করা টার্গেট যখন প্রতি শেয়ারের মুল্য হবেঃ <b>{data.target}</b> টাকা <br></br>
                ৪। <b>{data.target}</b>  টাকায় প্রতি শেয়ার বিক্রি করলে পাওয়া যাবে ({data.stock} * {data.target} - ভ্যাট {data.vat} ) = <b>{((data.stock*data.target)-data.vat).toLocaleString()}</b>  টাকা <br></br>
            </p>
          </div>
        </div>
      </main>
